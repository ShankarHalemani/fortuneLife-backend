...
public class AdminServiceImpl implements AdminService {
    ...
    public AdminDto updateAdmin(UserDto userDto) {
        ...
        // Optional<Address> addressById =
        // addressRepository.findById(userDto.getAddressDto().getId());
        // if (addressById.isEmpty()) {
        // throw new AdminRelatedException("No Address Found for Address Id " +
        // userDto.getAddressDto().getId());
        // }
