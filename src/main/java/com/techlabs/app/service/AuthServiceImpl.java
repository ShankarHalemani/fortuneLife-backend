...
public class AuthServiceImpl implements AuthService {
    ...
    public AuthServiceImpl(OtpRepository otpRepository, TokenRepository tokenRepository,
            AddressRepository addressRepository, CustomerRepository customerRepository, AgentRepository agentRepository,
            EmployeeRepository employeeRepository, AdminRepository adminRepository, UserRepository userRepository,
