...
import com.techlabs.app.security.RateLimitFilter;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http.csrf(csrf -> csrf.disable()).cors(withDefaults()).authorizeHttpRequests(authorize -> authorize
                ...
                .requestMatchers(HttpMethod.PUT, "/fortuneLife/customer")
                .hasAnyRole("ADMIN", "EMPLOYEE", "CUSTOMER", "AGENT")
                ...
                // Payment endpoint
                .requestMatchers(HttpMethod.POST, "/fortuneLife/payments/create-order").permitAll()
                .requestMatchers(HttpMethod.POST, "/fortuneLife/payments/verify").permitAll()
                ...
                // Dashboard endpoints
                .requestMatchers(HttpMethod.GET, "/fortuneLife/dashboard/**")
                .hasAnyRole("ADMIN", "EMPLOYEE")

                // Search endpoint
                .requestMatchers(HttpMethod.GET, "/fortuneLife/search")
                .hasAnyRole("ADMIN", "EMPLOYEE", "AGENT")
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setExposedHeaders(Arrays.asList("Authorization", "File-Name"));
